...
sudo socat -b 1048576 'VSOCK-LISTEN:6000,fork,reuseaddr,max-children=20,linger=5,sockopt-sock=40:2:x0000000100000000,sockopt-sock=40:0:x0000000100000000' UNIX-CONNECT:/tmp/.X11-unix/X1
