...
struct pal_initial_mem_range {
    ...
    /* Denotes a range reserved from PAL allocations that a user mapping may later replace. */
    bool is_user_reserved;
...
int PalSocketRegisterShmem(PAL_HANDLE handle, void *region);
