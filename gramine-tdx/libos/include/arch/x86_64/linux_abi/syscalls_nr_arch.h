...
/* Secure gaming: some file descriptors are host-based, and we need to pass them as-is. */
#ifndef __NR_register_host_identity_fd
#define __NR_register_host_identity_fd 451
#endif
